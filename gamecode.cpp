...
#include <math.h>
#include "shapes.h"
//todo include each object.h file
#include "Spaceship.h"
#include "Rock.h"
...
ErrorType Game::StartOfGame()
{
   ...
   // **********************************************************************
	// create objects here and add them to object manager
	//m_objectManager = new ObjectManager;

	Spaceship* pSpaceship = new Spaceship();
	pSpaceship->Initialise(Vector2D(-150,-450));
	m_objectManager.AddObject(pSpaceship);


	Rock* pRock1 = new Rock();
	pRock1->Initialise(Vector2D(5, 5));
	m_objectManager.AddObject(pRock1);
...
ErrorType Game::Update()
{
   ...
   // *********************************************************************
	...
	m_objectManager.UpdateAll(gt.mdFrameTime);
